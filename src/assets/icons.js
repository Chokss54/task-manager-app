/**
 * This file stores all exports for icons used in the app
 */
...
export const SunnyIcon = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" className="bi bi-cloud-sun-fill" viewBox="0 0 16 16">
